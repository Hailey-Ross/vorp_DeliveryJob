...
Config.ShowBlips = false -- Show Point blips
...
Config.MainJob = {
    {job =1, x=-179.51,y=627.02,z=114.09}, -- Valentine
...
Config.Cart5 = {x=1233.86,y=-1269.87,z=75.51,h=-35.92} -- Cart spawn point
Config.StartWorking5 = "Blackwater." -- Start Working Message
Config.Cash5 = 15.0 -- Cash payout
Config.Exp5 = 10 -- EXP payout
